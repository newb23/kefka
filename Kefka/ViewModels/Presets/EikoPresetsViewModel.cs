...
{
    public class EikoPresetsViewModel : BaseViewModel
    {
        ...
        public EikoSettingsModel Settings => EikoSettingsModel.Instance;

        public EikoPresetsSettingsModel Presets => EikoPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Eiko");
