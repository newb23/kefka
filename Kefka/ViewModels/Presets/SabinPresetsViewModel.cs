...
{
    public class SabinPresetsViewModel : BaseViewModel
    {
        ...
        public SabinSettingsModel Settings => SabinSettingsModel.Instance;

        public SabinPresetsSettingsModel Presets => SabinPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Sabin");
