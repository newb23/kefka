...
{
    public class ShadowPresetsViewModel : BaseViewModel
    {
        ...
        public ShadowSettingsModel Settings => ShadowSettingsModel.Instance;

        public ShadowPresetsSettingsModel Presets => ShadowPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Shadow");
