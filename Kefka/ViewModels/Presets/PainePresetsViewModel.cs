...
{
    public class PainePresetsViewModel : BaseViewModel
    {
        ...
        public PaineSettingsModel Settings => PaineSettingsModel.Instance;

        public PainePresetsSettingsModel Presets => PainePresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Paine");
