...
{
    public class CyanPresetsViewModel : BaseViewModel
    {
        ...
        public CyanSettingsModel Settings => CyanSettingsModel.Instance;

        public CyanPresetsSettingsModel Presets => CyanPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Cyan");
