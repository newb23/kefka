...
{
    public class ViviPresetsViewModel : BaseViewModel
    {
        ...
        public ViviSettingsModel Settings => ViviSettingsModel.Instance;

        public ViviPresetsSettingsModel Presets => ViviPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Vivi");
