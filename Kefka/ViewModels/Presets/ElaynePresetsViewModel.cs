...
{
    public class ElaynePresetsViewModel : BaseViewModel
    {
        ...
        public ElayneSettingsModel Settings => ElayneSettingsModel.Instance;

        public ElaynePresetsSettingsModel Presets => ElaynePresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Elayne");
