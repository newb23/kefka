...
{
    public class BeatrixPresetsViewModel : BaseViewModel
    {
        ...
        public BeatrixSettingsModel Settings => BeatrixSettingsModel.Instance;

        public BeatrixPresetsSettingsModel Presets => BeatrixPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Beatrix");
