...
{
    public class SuritoPresetsViewModel : BaseViewModel
    {
        ...
        public SuritoSettingsModel Settings => SuritoSettingsModel.Instance;

        public SuritoPresetsSettingsModel Presets => SuritoPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Surito");
