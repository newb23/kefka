...
{
    public class FreyaPresetsViewModel : BaseViewModel
    {
        ...
        public FreyaSettingsModel Settings => FreyaSettingsModel.Instance;

        public FreyaPresetsSettingsModel Presets => FreyaPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Freya");
