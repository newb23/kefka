...
{
    public class RemielPresetsViewModel : BaseViewModel
    {
        ...
        public RemielSettingsModel Settings => RemielSettingsModel.Instance;

        public RemielPresetsSettingsModel Presets => RemielPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Remiel");
