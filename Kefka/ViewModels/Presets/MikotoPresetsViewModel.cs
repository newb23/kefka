...
{
    public class MikotoPresetsViewModel : BaseViewModel
    {
        ...
        public MikotoSettingsModel Settings => MikotoSettingsModel.Instance;

        public MikotoPresetsSettingsModel Presets => MikotoPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Mikoto");
