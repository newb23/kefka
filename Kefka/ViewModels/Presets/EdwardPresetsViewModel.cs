...
{
    public class EdwardPresetsViewModel : BaseViewModel
    {
        ...
        public EdwardSettingsModel Settings => EdwardSettingsModel.Instance;

        public EdwardPresetsSettingsModel Presets => EdwardPresetsSettingsModel.Instance;

        private static string initPath = Path.Combine(Environment.CurrentDirectory, @"Settings\" + Me.Name + @"\Kefka\Routine Settings\Edward");
