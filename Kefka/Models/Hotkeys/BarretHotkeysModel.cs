...
namespace Kefka.Models
{
    public class BarretHotkeysModel : BaseModel
    {
        ...
        private BarretHotkeysModel() : base(CharacterSettingsDirectory + "/Kefka/Hotkeys/Barret_Hotkeys.json")
        {
        }

        private Keys _preset1Key,
            _preset2Key,
            _preset3Key,
            _preset4Key,
            _preset5Key,
        ...
        private ModifierKeys _preset1Modifier,
            _preset2Modifier,
            _preset3Modifier,
            _preset4Modifier,
            _preset5Modifier,
            ...
            _heartBreakModifier,
            _aoeModifier,
            _gaussBarrelModifier,
            _interruptModifier,
            _autoAmmoModifier,
            _useAutoTurretModifier,
            _openerModifier,
            _hyperchargeModifier,
            _forceOverheatModifier,
            _wildfireModifier,
            _flamethrowerModifier,
            _overdriveModifier;
        ...
        public void RegisterAll()
        {
            ...
            {
                ToastManager.AddToast($"Loading Preset: {BarretPresetsSettingsModel.Instance.Preset1Name}",
                    TimeSpan.FromMilliseconds(750), MainSettingsModel.Instance.ToastColor(true), Colors.White,
            ...
            {
                ToastManager.AddToast($"Loading Preset: {BarretPresetsSettingsModel.Instance.Preset2Name}",
                    TimeSpan.FromMilliseconds(750), MainSettingsModel.Instance.ToastColor(true), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);
            ...
            {
                ToastManager.AddToast($"Loading Preset: {BarretPresetsSettingsModel.Instance.Preset3Name}",
                    TimeSpan.FromMilliseconds(750), MainSettingsModel.Instance.ToastColor(true), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);
            ...
            {
                ToastManager.AddToast($"Loading Preset: {BarretPresetsSettingsModel.Instance.Preset4Name}",
                    TimeSpan.FromMilliseconds(750), MainSettingsModel.Instance.ToastColor(true), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);
            ...
            {
                ToastManager.AddToast($"Loading Preset: {BarretPresetsSettingsModel.Instance.Preset5Name}",
                    TimeSpan.FromMilliseconds(750), MainSettingsModel.Instance.ToastColor(true), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);
            ...
            HotkeyManager.Register("Barret_Blank", BlankKey, BlankModifier, hk =>
            {
                ...
                ToastManager.AddToast(BarretSettingsModel.Instance.UseBlank ? "Blank Enabled!" : "Blank Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseBlank), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);
            ...
            HotkeyManager.Register("Barret_Potion", PotionKey, PotionModifier, hk =>
            {
                ...
                ToastManager.AddToast(
                    BarretSettingsModel.Instance.UseDpsPotion ? "Potions Enabled!" : "Potions Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseDpsPotion), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);
            ...
            HotkeyManager.Register("Barret_Buffs", BuffsKey, BuffsModifier, hk =>
            {
                ...
                ToastManager.AddToast(BarretSettingsModel.Instance.UseBuffs ? "Buffs Enabled!" : "Buffs Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseBuffs), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);
            ...
            HotkeyManager.Register("Barret_HeartBreak", HeartBreakKey, HeartBreakModifier, hk =>
            {
                ...
                ToastManager.AddToast(
                    BarretSettingsModel.Instance.UseHeartBreak ? "HeartBreak Enabled!" : "HeartBreak Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseHeartBreak), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);

                Logger.BarretLog(BarretSettingsModel.Instance.UseHeartBreak
                    ? "HeartBreak Enabled!"
                    : "HeartBreak Disabled!");
            });
            ...
            HotkeyManager.Register("Barret_AoE", AoEKey, AoEModifier, hk =>
            {
                ...
                ToastManager.AddToast(BarretSettingsModel.Instance.UseAoE ? "AoEs Enabled!" : "AoEs Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseAoE), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);
            ...
            HotkeyManager.Register("Barret_GaussBarrel", GaussBarrelKey, GaussBarrelModifier, hk =>
            {
                ...
                ToastManager.AddToast(
                    BarretSettingsModel.Instance.UseGaussBarrel ? "Gauss Barrel Enabled!" : "Gauss Barrel Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseGaussBarrel), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);

                Logger.BarretLog(BarretSettingsModel.Instance.UseGaussBarrel
                    ? "Gauss Barrel Enabled!"
                    : "Gauss Barrel Disabled!");
            });
            ...
            HotkeyManager.Register("Barret_AutoInterrupt", InterruptKey, InterruptModifier, hk =>
            {
                ...
                ToastManager.AddToast(
                    BarretSettingsModel.Instance.UseManualInterrupt ? "Interrupts Enabled!" : "Interrupts Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseManualInterrupt),
                ...
                Logger.BarretLog(BarretSettingsModel.Instance.UseManualInterrupt
                    ? "Interrupts Enabled!"
                    : "Interrupts Disabled!");
            });
            ...
            HotkeyManager.Register("Barret_AutoAmmo", AutoAmmoKey, AutoAmmoModifier, hk =>
            {
                ...
                ToastManager.AddToast(
                    BarretSettingsModel.Instance.UseAutoAmmo ? "Auto-Ammo Enabled!" : "Auto-Ammo Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseAutoAmmo), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);

                Logger.BarretLog(
                    BarretSettingsModel.Instance.UseAutoAmmo ? "Aut-oAmmo Enabled!" : "Auto-Ammo Disabled!");
            });
            ...
            HotkeyManager.Register("Barret_AutoTurret", AutoTurretKey, AutoTurretModifer, hk =>
            {
                ...
                ToastManager.AddToast(
                    BarretSettingsModel.Instance.UseAutoTurret ? "Auto-Turret Enabled!" : "Auto-Turret Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseAutoTurret), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);

                Logger.BarretLog(BarretSettingsModel.Instance.UseAutoTurret
                    ? "Auto-Turret Enabled!"
            ...
            HotkeyManager.Register("Barret_Opener", OpenerKey, OpenerModifier, hk =>
            {
                ...
                ToastManager.AddToast(BarretSettingsModel.Instance.UseOpener ? "Opener Enabled!" : "Opener Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseOpener), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);
            ...
            HotkeyManager.Register("Barret_Cooldowns", CooldownsKey, CooldownsModifier, hk =>
            {
                ...
                ToastManager.AddToast(
                    BarretSettingsModel.Instance.UseCooldowns ? "Cooldowns Enabled!" : "Cooldowns Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseCooldowns), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);

                Logger.BarretLog(BarretSettingsModel.Instance.UseCooldowns
                    ? "Cooldowns Enabled!"
                    : "Cooldowns Disabled!");
            });
            ...
            HotkeyManager.Register("Barret_Hypercharge", HyperchargeKey, HyperchargeModifier, hk =>
            {
                ...
                ToastManager.AddToast(
                    BarretSettingsModel.Instance.UseHypercharge ? "Hypercharge Enabled!" : "Hypercharge Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseHypercharge), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);

                Logger.BarretLog(BarretSettingsModel.Instance.UseHypercharge
                    ? "Hypercharge Enabled!"
                    : "Hypercharge Disabled!");
            });

            HotkeyManager.Register("Barret_ForceOverheat", ForceOverheatKey, ForceOverheatModifier, hk =>
            {
                ToastManager.AddToast("Forcing Overheat!", TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(true), Colors.White, new FontFamily("High Tower Text Italic"),
                    new FontWeight(), 52);
            ...
            HotkeyManager.Register("Barret_Wildfire", WildfireKey, WildfireModifier, hk =>
            {
                ...
                ToastManager.AddToast(
                    BarretSettingsModel.Instance.UseWildfire ? "Wildfire Enabled!" : "Wildfire Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseWildfire), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);
            ...
            {
                ToastManager.AddToast("Forcing Overdrive!", TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(true), Colors.White, new FontFamily("High Tower Text Italic"),
                    new FontWeight(), 52);
            ...
            HotkeyManager.Register("Barret_Flamethrower", FlamethrowerKey, FlamethrowerModifier, hk =>
            {
                ...
                ToastManager.AddToast(
                    BarretSettingsModel.Instance.UseFlamethrower ? "Flamethrower Enabled!" : "Flamethrower Disabled!",
                    TimeSpan.FromMilliseconds(750),
                    MainSettingsModel.Instance.ToastColor(BarretSettingsModel.Instance.UseFlamethrower), Colors.White,
                    new FontFamily("High Tower Text Italic"), new FontWeight(), 52);

                Logger.BarretLog(BarretSettingsModel.Instance.UseFlamethrower
                    ? "Flamethrower Enabled!"
                    : "Flamethrower Disabled!");
            });
        }
